...
describe('String Extension', function() {
  ...
  it('should be able to right trim a value of \'text with extra spaces on the right   \'', function() {
    var message = 'text with extra spaces on the right   '.trim();
  ...
  it('should be able to trim a value of \'   text with extra spaces on the left\'', function() {
    var message = '   text with extra spaces on the left'.trim();
  ...
  it('should be able to center the value \'foobar\' with spaces to make it 8 wide (1 spaces on each side)', function() {
    var message = 'foobar'.center(8);
